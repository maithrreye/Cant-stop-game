...
class Board:
    def __init__(self, column_range, offset, initial_height):
        ...
        #print("self.column_range[0]" + str(self.column_range[1]))
...
class Game:
    ...
    def number_positions_conquered_this_round(self, column):
        ...
        #print("I am printing this one... ")
        #print(column) #['2', '3', '4', '5', '6']
        #print(str(type(column)))# This is a list 
        #print(str(type(self.board_game.board))) # This is a list 
        list_of_cells = self.board_game.board[column]
        #list_of_cells = [self.board_game.board[i] for i in column]


        for i in range(len(list_of_cells)):
            #print("List of cells...." + str(list_of_cells))
            #print("List of cells marker...."+ str(list_of_cells[i].markers))
            if self.player_turn in list_of_cells[i].markers:
                #print("self.player_turn ...." + str(self.player_turn))
                previously_conquered = i
                #print("previously_conquered.." + str(previously_conquered))
    ...
    def play(self, chosen_play):
        ...
        for die_position in range(len(chosen_play)):
            ...
            #print("die_position..." + str(die_position))
