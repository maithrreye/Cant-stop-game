...
class Script39(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.actionWinsColumn(state,a) and DSL.isDoubles(a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.numberPositionsConquered(state, 4 ) > 2 and DSL.containsNumber(a, 4 ):
            ...
            if DSL.numberPositionsConquered(state, 5 ) > 1 and DSL.containsNumber(a, 5 ) and DSL.isDoubles(a) and DSL.isDoubles(a):
                self._counter_calls[15] += 1
                return a
                    
            if DSL.numberPositionsConquered(state, 4 ) > 2 and DSL.containsNumber(a, 4 ) and DSL.actionWinsColumn(state,a):
            ...
            if DSL.numberPositionsProgressedThisRoundColumn(state, 5 ) > 1 and DSL.isStopAction(a):
