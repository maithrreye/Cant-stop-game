...
class Script64(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.containsNumber(a, 6 ) and DSL.actionWinsColumn(state,a):
            ...
            if DSL.containsNumber(a, 4 ) and DSL.containsNumber(a, 4 ) and DSL.isDoubles(a):
            ...
            if DSL.isDoubles(a) and DSL.containsNumber(a, 3 ) and DSL.isDoubles(a):
                self._counter_calls[7] += 1
                return a
                    
            if DSL.containsNumber(a, 5 ) and DSL.isDoubles(a):
            ...
            if DSL.actionWinsColumn(state,a) and DSL.containsNumber(a, 4 ):
                self._counter_calls[12] += 1
                return a
                    
            if DSL.numberPositionsConquered(state, 5 ) > 0 and DSL.containsNumber(a, 5 ) and DSL.containsNumber(a, 3 ):
                self._counter_calls[13] += 1
                return a
                    
            if DSL.containsNumber(a, 4 ) and DSL.actionWinsColumn(state,a) and DSL.hasWonColumn(state,a):
            ...
            if DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 4 ) > 1 and DSL.isStopAction(a):
                self._counter_calls[22] += 1
                return a
                    
            if DSL.numberPositionsProgressedThisRoundColumn(state, 5 ) > 0 and DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 6 ) > 0 and DSL.isStopAction(a):
                self._counter_calls[23] += 1
                return a
                    
            if DSL.isStopAction(a) and DSL.isStopAction(a) and DSL.isStopAction(a):
            ...
            if DSL.numberPositionsProgressedThisRoundColumn(state, 2 ) > 0 and DSL.isStopAction(a) and DSL.isStopAction(a) and DSL.isStopAction(a):
                self._counter_calls[28] += 1
                return a
                    
            if DSL.numberPositionsConquered(state, 5 ) > 1 and DSL.containsNumber(a, 5 ) and DSL.numberPositionsConquered(state, 5 ) > 0 and DSL.containsNumber(a, 5 ) and DSL.containsNumber(a, 3 ):
