...
class Script8(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.hasWonColumn(state,a) and DSL.numberPositionsProgressedThisRoundColumn(state, 6 ) > 0 and DSL.isStopAction(a):
            ...
            if DSL.containsNumber(a, 6 ) and DSL.hasWonColumn(state,a) and DSL.containsNumber(a, 3 ):
