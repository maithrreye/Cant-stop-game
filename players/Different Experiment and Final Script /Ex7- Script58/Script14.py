...
class Script14(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.isDoubles(a) and DSL.containsNumber(a, 5 ) and DSL.hasWonColumn(state,a) and DSL.isDoubles(a):
            ...
            if DSL.numberPositionsProgressedThisRoundColumn(state, 6 ) > 0 and DSL.isStopAction(a) and DSL.isStopAction(a) and DSL.hasWonColumn(state,a):
