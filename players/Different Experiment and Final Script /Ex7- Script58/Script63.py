...
class Script63(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.isDoubles(a) and DSL.numberPositionsConquered(state, 5 ) > 0 and DSL.containsNumber(a, 5 ) and DSL.actionWinsColumn(state,a):
                self._counter_calls[13] += 1
                return a
                    
            if DSL.containsNumber(a, 4 ) and DSL.containsNumber(a, 4 ) and DSL.actionWinsColumn(state,a):
            ...
            if DSL.actionWinsColumn(state,a) and DSL.hasWonColumn(state,a) and DSL.hasWonColumn(state,a):
