...
class Script42(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.hasWonColumn(state,a) and DSL.numberPositionsProgressedThisRoundColumn(state, 6 ) > 1 and DSL.isStopAction(a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 4 ) > 2 and DSL.isStopAction(a) and DSL.hasWonColumn(state,a):
            ...
            if DSL.numberPositionsProgressedThisRoundColumn(state, 3 ) > 1 and DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 4 ) > 0 and DSL.isStopAction(a) and DSL.isStopAction(a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.containsNumber(a, 5 ):
                self._counter_calls[7] += 1
                return a
                    
            if DSL.actionWinsColumn(state,a) and DSL.isDoubles(a) and DSL.actionWinsColumn(state,a):
                self._counter_calls[8] += 1
                return a
                    
            if DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 3 ) > 2 and DSL.isStopAction(a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.numberPositionsProgressedThisRoundColumn(state, 2 ) > 1 and DSL.isStopAction(a):
            ...
            if DSL.isStopAction(a) and DSL.isStopAction(a) and DSL.numberPositionsProgressedThisRoundColumn(state, 2 ) > 0 and DSL.isStopAction(a):
            ...
            if DSL.containsNumber(a, 2 ) and DSL.isDoubles(a) and DSL.isDoubles(a):
            ...
            if DSL.actionWinsColumn(state,a) and DSL.hasWonColumn(state,a) and DSL.isDoubles(a):
                self._counter_calls[25] += 1
                return a
                    
            if DSL.containsNumber(a, 5 ) and DSL.isDoubles(a) and DSL.isDoubles(a) and DSL.actionWinsColumn(state,a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.containsNumber(a, 4 ):
