...
class Script17(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.containsNumber(a, 5 ) and DSL.hasWonColumn(state,a) and DSL.isDoubles(a):
            ...
            if DSL.hasWonColumn(state,a) and DSL.numberPositionsProgressedThisRoundColumn(state, 2 ) > 0 and DSL.isStopAction(a):
