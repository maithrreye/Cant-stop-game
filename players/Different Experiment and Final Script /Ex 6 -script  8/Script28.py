...
class Script28(Player):
    ...
    def get_action(self, state):
        ...
        for a in actions:
            ...
            if DSL.containsNumber(a, 2 ) and DSL.containsNumber(a, 2 ):
            ...
            if DSL.containsNumber(a, 4 ) and DSL.actionWinsColumn(state,a) and DSL.actionWinsColumn(state,a):
